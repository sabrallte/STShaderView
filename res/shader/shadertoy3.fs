...
// (C) 2016 by cr8tr / http://cr8tr.org / http://omnido.me
...
int map_mode = (iMouse.w > 0.0) ? MAP_EQUIRECTANGULAR : MAP_FISHEYE;
const float speed = 0.5;

// Camera rotation with mouse
float camera_yaw = iMouse.x / iResolution.x * 360.0;
float camera_pitch = iMouse.y / iResolution.y * 360.0;
