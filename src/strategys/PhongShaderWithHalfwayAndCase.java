...
public class PhongShaderWithHalfwayAndCase extends BaseStrategy{
	...
	public PhongShaderWithHalfwayAndCase() {
		init_options_panel();
		VERTEX_SHADER_LOCATION = "res/phong_with_halfway_fallunterscheidung.vs";
