...
public class PhongShaderWithHalfwayAndCaseAndSchlick extends BaseStrategy{
	...
	public PhongShaderWithHalfwayAndCaseAndSchlick() {
		init_options_panel();
		VERTEX_SHADER_LOCATION = "res/phong_with_halfway_fallunterscheidung_schlick.vs";
		FRAGMENT_SHADER_LOCATION = "res/phong_with_halfway.fs";
	}
...
//    	uniform vec3 lightDirection;  <----- fehlt noch!
        ...
        glUniform1f(specularPow, (float)sliderspecularPow.getValue() );
